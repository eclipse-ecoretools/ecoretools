 ...
 * 
 */
public class EEnumDataTypePropertiesEditionComponent extends SiriusAwarePropertiesEditingComponent {
	 ...
	 * 
	 */
	public EEnumDataTypePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject eEnum, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EcoreViewsRepository.DataType.Properties.name))
				dataTypePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eEnum.getName()));
			
			if (isAccessible(EcoreViewsRepository.DataType.Properties.serializable)) {
				dataTypePart.setSerializable(eEnum.isSerializable());
			}
			// init filters
