 ...
 * 
 */
public class EDataTypeInstanciationPropertiesEditionComponent extends SiriusAwarePropertiesEditingComponent {
	 ...
	 * 
	 */
	public EDataTypeInstanciationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject eDataType, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EcoreViewsRepository.Instanciation.instanceClassName))
				instanciationPart.setInstanceClassName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eDataType.getInstanceClassName()));
			
			if (isAccessible(EcoreViewsRepository.Instanciation.instanceTypeName))
				instanciationPart.setInstanceTypeName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, eDataType.getInstanceTypeName()));
