...
public class EAttributePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EAttributePropertiesEditionPart {
		...
		composer = new PartComposer(eAttributeStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EcoreViewsRepository.EAttribute.Cardinality.ListProperties.class) {
					return createListPropertiesHBox(widgetFactory, parent);
				}
	...
	protected Composite createCardinalityGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		cardinalitySection.setText(EcoreMessages.EAttributePropertiesEditionPart_CardinalityGroupLabel);
	...
	protected Composite createLowerBoundText(FormToolkit widgetFactory, Composite parent) {
		...
		lowerBound.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EAttributePropertiesEditionPartForm.this,
							EcoreViewsRepository.EAttribute.Cardinality.lowerBound,
		...
		lowerBound.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Cardinality.lowerBound, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, lowerBound.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Cardinality.lowerBound, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUpperBoundText(FormToolkit widgetFactory, Composite parent) {
		...
		upperBound.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EAttributePropertiesEditionPartForm.this,
							EcoreViewsRepository.EAttribute.Cardinality.upperBound,
		...
		upperBound.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Cardinality.upperBound, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, upperBound.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Cardinality.upperBound, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createListPropertiesHBox(FormToolkit widgetFactory, Composite parent) {
		...
		widgetFactory.adapt(listPropertiesHBox);
		return listPropertiesHBox;
	}

	
	protected Composite createUniqueCheckbox(FormToolkit widgetFactory, Composite parent) {
		unique = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Cardinality.ListProperties.unique, EcoreMessages.EAttributePropertiesEditionPart_UniqueLabel), SWT.CHECK);
		unique.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Cardinality.ListProperties.unique, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(unique.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Cardinality.ListProperties.unique, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOrderedCheckbox(FormToolkit widgetFactory, Composite parent) {
		ordered = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Cardinality.ListProperties.ordered, EcoreMessages.EAttributePropertiesEditionPart_OrderedLabel), SWT.CHECK);
		ordered.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Cardinality.ListProperties.ordered, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(ordered.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Cardinality.ListProperties.ordered, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBehaviorGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		behaviorSection.setText(EcoreMessages.EAttributePropertiesEditionPart_BehaviorGroupLabel);
	...
	protected Composite createDerivedCheckbox(FormToolkit widgetFactory, Composite parent) {
		derived = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Behavior.Changeability.derived, EcoreMessages.EAttributePropertiesEditionPart_DerivedLabel), SWT.CHECK);
		derived.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Behavior.Changeability.derived, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(derived.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Behavior.Changeability.derived, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChangeableCheckbox(FormToolkit widgetFactory, Composite parent) {
		changeable = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Behavior.Changeability.changeable, EcoreMessages.EAttributePropertiesEditionPart_ChangeableLabel), SWT.CHECK);
		changeable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Behavior.Changeability.changeable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(changeable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Behavior.Changeability.changeable, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUnsettableCheckbox(FormToolkit widgetFactory, Composite parent) {
		unsettable = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Behavior.Changeability.unsettable, EcoreMessages.EAttributePropertiesEditionPart_UnsettableLabel), SWT.CHECK);
		unsettable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Behavior.Changeability.unsettable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(unsettable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Behavior.Changeability.unsettable, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTransient_Checkbox(FormToolkit widgetFactory, Composite parent) {
		transient_ = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Behavior.Others.transient_, EcoreMessages.EAttributePropertiesEditionPart_Transient_Label), SWT.CHECK);
		transient_.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Behavior.Others.transient_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(transient_.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Behavior.Others.transient_, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVolatile_Checkbox(FormToolkit widgetFactory, Composite parent) {
		volatile_ = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EAttribute.Behavior.Others.volatile_, EcoreMessages.EAttributePropertiesEditionPart_Volatile_Label), SWT.CHECK);
		volatile_.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EAttributePropertiesEditionPartForm.this, EcoreViewsRepository.EAttribute.Behavior.Others.volatile_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(volatile_.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EcoreViewsRepository.EAttribute.Behavior.Others.volatile_, EcoreViewsRepository.FORM_KIND), null); //$NON-NLS-1$
