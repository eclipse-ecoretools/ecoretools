 ...
 *         Cannenterre</a>
 */
public class UpdateAnchorLinkedEReferenceDeferredCommand extends AbstractTransactionalCommand {

	private EReferenceEditPart part1;

	private EReferenceEditPart part2;

	public UpdateAnchorLinkedEReferenceDeferredCommand(TransactionalEditingDomain domain, EReferenceEditPart part1, EReferenceEditPart part2) {
