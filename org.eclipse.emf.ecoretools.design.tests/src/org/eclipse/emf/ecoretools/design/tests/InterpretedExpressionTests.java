...
public class InterpretedExpressionTests {
    ...
    public void isNotAcceleo() {
        if (underTest.getExpression().indexOf("<%") > -1) {
            fail("Expression : " + underTest.getExpression() + " is Acceleo2, on attribute :" + underTest.getFeature().getName() + " of object " + EcoreUtil.getURI(underTest.getDeclaration()));
        }
        if (underTest.getExpression().indexOf("[") > -1) {
            fail("Expression : " + underTest.getExpression() + " is Acceleo, on attribute :" + underTest.getFeature().getName() + " of object " + EcoreUtil.getURI(underTest.getDeclaration()));
        }
    }
